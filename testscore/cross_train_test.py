...
def parse_option():
    ...
    # parser.add_argument('--pre_trained_path', type=str, default="/data/wst/video-pace/testscore/pre/1210/mlpepoch-20.pth.tar", help='0.8 0.8 0.5')
    parser.add_argument('--pre_trained_path', type=str, default="/data/wst/video-pace/testscore/pre/1210/mlpepoch-18.pth.tar", help='')
    # parser.add_argument('--pre_trained_path', type=str, default="/data/wst/video-pace/pretrain_cks/sr_4_mymodelv4_lr_0.001_len_16_sz_112_mytrain3/2023-12-16/mlpepoch-18.pth.tar", help='0.8 0.8 0.5')
